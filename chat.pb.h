...
inline const std::string& DataType_Name(T enum_t_value) {
    static_assert(
        ::std::is_same<T, DataType>::value || ::std::is_integral<T>::value,
        "Incorrect type passed to function DataType_Name.");
    return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(DataType_descriptor(),
                                                         enum_t_value);
}
inline bool DataType_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
                           DataType* value) {
...
class ChatMessage final
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:chat.ChatMessage)
                   */
{
   public:
...
// string user_name = 1;
inline void ChatMessage::clear_user_name() { _impl_.user_name_.ClearToEmpty(); }
...
inline PROTOBUF_ALWAYS_INLINE void ChatMessage::set_user_name(ArgT0&& arg0,
                                                              ArgT... args) {
    _impl_.user_name_.Set(static_cast<ArgT0&&>(arg0), args...,
...
// uint32 timestamp = 2;
inline void ChatMessage::clear_timestamp() { _impl_.timestamp_ = 0u; }
...
// .chat.DataType data_type = 3;
inline void ChatMessage::clear_data_type() { _impl_.data_type_ = 0; }
...
inline void ChatMessage::set_message_text(ArgT0&& arg0, ArgT... args) {
    ...
    _impl_.content_.message_text_.Set(static_cast<ArgT0&&>(arg0), args...,
                                      GetArenaForAllocation());
...
inline void ChatMessage::set_allocated_message_text(std::string* message_text) {
    ...
    if (message_text != nullptr) {
        set_has_message_text();
        _impl_.content_.message_text_.InitAllocated(message_text,
                                                    GetArenaForAllocation());
    }
...
inline void ChatMessage::set_image_data(ArgT0&& arg0, ArgT... args) {
    ...
    _impl_.content_.image_data_.SetBytes(static_cast<ArgT0&&>(arg0), args...,
                                         GetArenaForAllocation());
...
inline void ChatMessage::set_allocated_image_data(std::string* image_data) {
    ...
    if (image_data != nullptr) {
        set_has_image_data();
        _impl_.content_.image_data_.InitAllocated(image_data,
                                                  GetArenaForAllocation());
    }
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE void ChatMessage::set_image_extension(
    ArgT0&& arg0, ArgT... args) {
    _impl_.image_extension_.Set(static_cast<ArgT0&&>(arg0), args...,
                                GetArenaForAllocation());
...
inline void ChatMessage::_internal_set_image_extension(
    const std::string& value) {
...
inline void ChatMessage::set_allocated_image_extension(
    std::string* image_extension) {
    if (image_extension != nullptr) {
    } else {
    }
    _impl_.image_extension_.SetAllocated(image_extension,
                                         GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
template <>
struct is_proto_enum<::chat::DataType> : ::std::true_type {};
template <>
